...
class WelcomePage extends AbstractWelcomePage {
    ...
    _removeFriendFromMento = (friendID) => {
        if (this.state.Login) {
            ...
            mentoObj = {
                ...mentoObj,
                follower: [...mentoObj.follower.filter(_follower => _follwer != userid)]
            };
    ...
    _renderMessage() {
        const { messageWith, messageData, userid } = this.state;
        const { accountData } = this.state;
        let friendName = accountData[messageWith].username;
        let valueName = '';
        let messageObj = [];
        let divScroll = null;
